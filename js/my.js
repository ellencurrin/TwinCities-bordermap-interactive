...
function openDialog() {
	bootbox.dialog({
		message: '<p style="color: black;"> The US-Mexico border divides 14 cities into 28 municipalities- half in one country, and half in another. The border is obvious when you look at it on a map, but what effect does it have on the lives of those who live in these severed cities? The Twin Cities project aims to explore this question via social media. </br></br><b>To use this tool:</b> Click on any one of the 14 twin cities on the map to compare Instagram and Twitter content from both sides of the border.  Reset the zoom and explore another pair of municipalities. What things are the same? What things seem different? How is the impact on individual lives the same or different from what is portrayed in the media?</br></br>This project was made using the <a href=Òhttp://instagram.com/developer/Ó>Instagram API</a>, <a href=Òhttps://dev.twitter.com/Ó>Twitter API</a>, and <a href=Òhttps://developers.google.com/maps/Ó>Google Maps API</a>.</p>',
